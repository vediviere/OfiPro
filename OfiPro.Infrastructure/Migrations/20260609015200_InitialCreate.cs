        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainSpecialty = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableMaterials = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    InvitedPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectRequirements_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectRequirements_Subcategories_SubcategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Includes = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    DoesNotInclude = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    HasWarranty = table.Column<bool>(type: "bit", nullable: false),
                    WarrantyDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_Users_ContractorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostBenefit = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectRequirements_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectRequirements_SubcategoryId",
                table: "ProjectRequirements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Proposals_ContractorUserId",
                table: "Proposals",
